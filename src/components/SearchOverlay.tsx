      ...
      >
        ...
        <div style={{
          ...
          {query && (
            <button
              onClick={() => setQuery('')}
              style={{ background: 'none', border: 'none', color: '#fff', cursor: 'pointer', opacity: 0.7, display: 'flex', alignItems: 'center', justifyContent: 'center' }}
            >
              <FluentIcon name="close" size={14} white />
            </button>
          )}
        </div>
