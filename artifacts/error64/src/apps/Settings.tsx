...
const WALLPAPERS = [
  { id: 'gradient1', name: 'Midnight Blue', preview: 'linear-gradient(135deg, #0d1b2a, #1b2838, #16213e, #0f3460)' },
  { id: 'gradient2', name: 'Deep Ocean', preview: 'linear-gradient(135deg, #1a1a2e, #16213e, #0f3460)' },
  { id: 'gradient3', name: 'Blue Ridge', preview: 'linear-gradient(135deg, #0f2027, #203a43, #2c5364)' },
  { id: 'gradient4', name: 'Crimson Night', preview: 'linear-gradient(135deg, #200122, #6f0000)' },
  { id: 'gradient5', name: 'Forest', preview: 'linear-gradient(135deg, #093028, #237a57)' },
  { id: 'gradient6', name: 'Graphite', preview: 'linear-gradient(135deg, #232526, #414345)' },
];
          ...
          <div style={subsections}>
            <Subsection title="Background">
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '8px', marginBottom: '12px' }}>
                {WALLPAPERS.map(w => (
                  <div key={w.id} onClick={() => updateSettings({ wallpaper: w.id })}
                    style={{
                      height: '70px', background: w.preview, cursor: 'pointer',
                      border: `3px solid ${settings.wallpaper === w.id ? settings.accentColor : '#ddd'}`,
              ...
              <div style={{ fontSize: '12px', color: '#666' }}>Tip: Right-click to set custom wallpaper from image file</div>
            </Subsection>
